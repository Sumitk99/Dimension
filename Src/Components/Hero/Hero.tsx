...
const Hero = () => {
  return (
    <section className="relative flex flex-col items-center justify-center min-h-[70vh] w-full px-4  pb-12 bg-transparent overflow-hidden">
      ...
      <div className="relative z-10">
        {/* Announcement Pill */}
      <div className="mb-6">
        <span className="px-5 py-1 ml-68 rounded-full bg-white/10 text-pink-300 text-sm font-medium border border-pink-400/30 backdrop-blur-md shadow-sm">
